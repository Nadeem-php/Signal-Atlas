// Netlify Function wrapper for Signal Atlas.
// Adapts Netlify's Request/Response interface to the existing backend handler.
...
export default async (request, context) => {
  ...
  return signalAtlasHandler(req, res);
};

async function signalAtlasHandler(req, res) {
  try {
